...
/**
 * 原文地址:http://blog.csdn.net/smarticeberg/article/details/50717460
 * @Email:lijiayan_mail@163.com
 * @created_time 2016/11/02 14:11
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * #                                                   #
 * #                       _oo0oo_                     #
 * #                      o8888888o                    #
...
public class AScrollView extends ScrollView {
    ...
    private boolean isCanPullDown() {
        Log.e(TAG, "down getScrollY()==0:" + (getScrollY() == 0));
        Log.e(TAG, "down contentView.getHeight() < getHeight() + getScrollY()" + (contentView.getHeight() < getHeight() + getScrollY()));
    ...
    private boolean isCanPullUp() {
        Log.e(TAG, "up contentView.getHeight() <= getScrollY() + getHeight():" + (contentView.getHeight() <= getScrollY() + getHeight()));
